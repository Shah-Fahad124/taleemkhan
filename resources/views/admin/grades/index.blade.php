...
<div class="app-content">
    <section class="section">
        <div class="page-header p-2">
            <h4 class="page-title font-weight-bold">Grade Management</h4>
            <ol class="breadcrumb">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="mb-0">All Grades</h4>
                <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addgradeModal" style="width: 8rem !important">
                    Add Grade
                </button>
            </div>
